...
const WalletModal = ({ open, setOpen }) => {
    ...
    const loadDepositAddress = async () => {
        if (open && currencies && currencies[depositCurrencyType]) {
            showLoading();
    ...
    const handleWithdraw = async () => {
        if (!currencies || !currencies[withdrawCurrencyType]) {
            addToast('Please select a valid currency', { appearance: 'error', autoDismiss: true });
            return;
        }
    ...
    // Safety check: don't render if currencies are not loaded
